/*
  ...
  1. New Tables
    - `call_records`
      ...
      - `completed_at` (timestamptz, auto-updated via trigger)
  ...
  3. Performance
    - Indexes on created_at, status, user_id, phone_number
    - Automatic trigger for completed_at timestamp

  4. Sample Data
    - Three example call records for testing
*/
